...
@Setter
@ToString
@Schema(description = "Patch 샘플 모델")
public class PatchSampleModel {
    ...
    @AllArgsConstructor
    @Builder
    @Schema(description = "Patch 샘플 요청 모델 (Request path , query의 schema 정보는 컨트롤러에 parameter 어노테이션 내에 기입)")
    ...
    @AllArgsConstructor
    @Builder
    @Schema(description = "Patch 샘플 응답 모델")
