...
public class PostSampleModel {
    ...
    @AllArgsConstructor
    @Builder
    @Schema(description = "Post 샘플 요청 모델 (Request path , query의 schema 정보는 컨트롤러에 parameter 어노테이션 내에 기입)")
    public static class Request {
        ...
        @Schema(description = "sampleKeyQuery1 설명")
        @NotBlank(message = "sampleKeyQuery1 필수입니다.")
        private String sampleKeyQuery1;

        @Schema(description = "sampleKeyQuery2 설명")
        @NotBlank(message = "sampleKeyQuery2 필수입니다.")
        private String sampleKeyQuery2;
    }
    ...
    @AllArgsConstructor
    @Builder
    @Schema(description = "Post 샘플 요청 body 모델")
    ...
    @Schema(description = "Post 샘플 응답 모델")
    @Getter
    @Setter
    @ToString
    @NoArgsConstructor
